...
use App\Http\Controllers\Api\Buffalo\NewBuffaloAdminController;
use App\Http\Controllers\Api\Buffalo\NewBuffaloCallbackController;
...
// new buffalo api start 
Route::post('/balance', [NewBuffaloCallbackController::class, 'balance']);
Route::put('/balance/update', [NewBuffaloCallbackController::class, 'updateBalance']);
Route::post('/ws/rtp', [NewBuffaloAdminController::class, 'updateRtp']);
Route::post('/ws/server-maintain', [NewBuffaloAdminController::class, 'updateServerMaintenance']);
Route::post('/ws/reset-server', [NewBuffaloAdminController::class, 'resetServer']);
//Route::post('/ws/launch-game', [NewBuffaloCallbackController::class, 'launchGame']);
