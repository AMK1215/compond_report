            ...
            <div class="card col-lg-6 offset-lg-3 col-md-8 offset-md-2" style="border-radius: 15px;">
                <div class="card-header">
                    <div class="card-title col-12">
                        <h5 class="d-inline fw-bold">Withdraw from {{ $agent->name }}</h5>
                ...
                <form action="{{ route('agent.sub-agent.makeCashOut', $agent->id) }}" method="POST">
                    @csrf
                    <div class="card-body mt-2">
                        ...
                        <div class="form-group">
                            ...
                            <span class="badge badge-success">
                                Agent Balance: {{ number_format($agent->balanceFloat, 2) }}
                            </span>
