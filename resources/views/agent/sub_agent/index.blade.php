            ...
            <div class="row">
                <div class="col-12">
                    <div class="d-flex justify-content-end mb-3">
                        <a href="{{ route('agent.sub-agent.create') }}" class="btn btn-success" style="width: 120px;">
                        ...
                        <div class="card-body">
                            <table id="mytable" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                        ...
                                        <tr class="text-center">
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('admin.agent.game_report.index', $user->id) }}"
                                                    class="btn btn-info btn-sm mt-1" data-bs-toggle="tooltip" title="Logs">
                                                    <i class="fas fa-right-left text-white mr-1"></i>Reports
                                                </a>
                                                <a href="{{ route('agent.sub-agent.logs', $user->id) }}"
                                                    class="btn btn-info btn-sm mt-1" data-bs-toggle="tooltip" title="Logs">
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="9" class="text-center">No sub-agents found.</td>
                                        </tr>
                                    @endforelse
                                </tbody>
                            </table>
