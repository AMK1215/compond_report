            ...
            <div class="card col-lg-6 offset-lg-3 col-md-8 offset-md-2" style="border-radius: 15px;">
                <div class="card-header">
                    <div class="card-title col-12">
                        <h5 class="d-inline fw-bold">Create Agent</h5>
                ...
                <form action="{{ route('agent.sub-agent.store') }}" method="POST">
                    @csrf
                    <div class="card-body mt-2">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="referral_code" value="{{ $referral_code }}" hidden>
                            @error('referral_code')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="card-footer col-12 bg-white">
                        <button type="submit" class="btn btn-success float-right">Create Sub-Agent</button>
                    </div>
                </form>
            </div>
        </div>
