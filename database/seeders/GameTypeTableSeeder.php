...
class GameTypeTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $gameTypes = [
            ...
            ['code' => 'SPORT_BOOK', 'name' => 'Sport Book', 'name_mm' => 'Sport Book', 'img' => 'sportbook.png', 'status' => 0, 'order' => '3'],
            ['code' => 'VIRTUAL_SPORT', 'name' => 'Virtual Sport', 'name_mm' => 'Virtual Sport', 'img' => 'virtual_sport.png', 'status' => 0, 'order' => '4'],
            ['code' => 'LOTTERY', 'name' => 'Lottery', 'name_mm' => 'Lottery', 'img' => 'lottery.png', 'status' => 0, 'order' => '5'],
            ...
            ['code' => 'POKER', 'name' => 'Poker', 'name_mm' => 'Poker', 'img' => 'poker.jpg', 'status' => 0, 'order' => '12'],
            ...
            //new game types
            ['code' => 'BUFFALO', 'name' => 'Buffalo', 'name_mm' => 'Buffalo', 'img' => 'buffalo.png', 'status' => 1, 'order' => '15'],
            ['code' => 'SHAN', 'name' => 'Shan', 'name_mm' => 'Shan', 'img' => 'shan.png', 'status' => 1, 'order' => '16'],
            ['code' => 'PONE_WINE', 'name' => 'Pone Wine', 'name_mm' => 'Pone Wine', 'img' => 'pone_wine.png', 'status' => 1, 'order' => '17'],
